...
public class Order   {
  ...
  public Order consumerId(String consumerId) {
   ...
   * @return consumerId
  **/
  @ApiModelProperty(example = "null", value = "Identifies the consumer to allow for one to one personalization.")
   ...
   * @return orderId
  **/
  @ApiModelProperty(example = "null", required = true, value = "Identifies the order.")
   ...
   * @return storeId
  **/
  @ApiModelProperty(example = "null", value = "Links the order to a store.")
   ...
   * @return date
  **/
  @ApiModelProperty(example = "null", value = "'YYYY-MM-DD HH:mm:ss' formatted date object specifying a (4 digit year, 2 digit month, 2 digit day, 0-24 hour, 2 digit minute and 2 digit second) time interval in GMT. Will use current date if not provided.")
  ...
  public Order campaign(String campaign) {
   ...
   * @return campaign
  **/
  @ApiModelProperty(example = "null", value = "Flexible identifier specifying the campaign this order belongs to. Used for A/B testing.")
   ...
   * @return items
  **/
  @ApiModelProperty(example = "null", required = true, value = "Individual transaction elements in this order.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Order order = (Order) o;
    return Objects.equals(this.consumerId, order.consumerId) &&
        Objects.equals(this.orderId, order.orderId) &&
        Objects.equals(this.storeId, order.storeId) &&
        Objects.equals(this.date, order.date) &&
        Objects.equals(this.campaign, order.campaign) &&
        Objects.equals(this.items, order.items);
  }

  @Override
  public int hashCode() {
    return Objects.hash(consumerId, orderId, storeId, date, campaign, items);
  }
