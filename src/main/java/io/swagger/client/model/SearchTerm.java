...
public class SearchTerm   {
  ...
  public SearchTerm text(String text) {
    this.text = text;
    return this;
  }
   ...
   * @return text
  **/
  @ApiModelProperty(example = "null", required = true, value = "Full text for an autocompleted search term.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.text, searchTerm.text);
  }
