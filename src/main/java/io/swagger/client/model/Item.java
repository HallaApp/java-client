...
public class Item   {
   ...
   * @return product
  **/
  @ApiModelProperty(example = "null", value = "Product in a given transaction.")
   ...
   * @return code
  **/
  @ApiModelProperty(example = "null", value = "Denotes that a given purchase does or does not have an item. Can represent purchases, coupons, bottle returns, refunds, etc.")
   ...
   * @return cost
  **/
  @ApiModelProperty(example = "null", value = "The cost of this transaction in the currency of this store's country.")
   ...
   * @return quantity
  **/
  @ApiModelProperty(example = "null", value = "Amount sold.")
  ...
  public Item unitOfMeasure(String unitOfMeasure) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Unit this purchase is measured in. 'count, lb, kg, oz, ml, etc.'")
   ...
   * @return message
  **/
  @ApiModelProperty(example = "null", value = "Flexible means of ingesting additiional transaction level information.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.product, item.product) &&
        ...
        Objects.equals(this.message, item.message);
  }

  @Override
  public int hashCode() {
    return Objects.hash(product, code, cost, quantity, unitOfMeasure, message);
  }
