...
import io.swagger.client.model.ProductSummary;
import java.util.ArrayList;
import java.util.List;


/**
 * An environment housing a given catalog. Can represent a store, distribution center, etc.
 */
@ApiModel(description = "An environment housing a given catalog. Can represent a store, distribution center, etc.")
...
public class Store   {
  ...
  private ProductSummary productSummary = null;
   ...
   * @return id
  **/
  @ApiModelProperty(example = "null", required = true, value = "Used across services to link to this store object.")
  public String getId() {
    return id;
  }
  ...
  public Store channel(String channel) {
   ...
   * @return channel
  **/
  @ApiModelProperty(example = "null", value = "The application type that will be using Halla's services. 'Choose from E_COMMERCE, SELF_SCAN, SMART_CART, PROMOTIONS, OTHER.'")
   ...
   * @return type
  **/
  @ApiModelProperty(example = "null", value = "The type of store that will be using Halla's services. 'Choose from GROCERY_STORE, SUPER_STORE, CONVENIENCE, DELI, OTHER.'")
  ...
  public Store brand(String brand) {
    this.brand = brand;
    return this;
  }
   ...
   * @return brand
  **/
  @ApiModelProperty(example = "null", value = "Brand of store.")
   ...
   * @return postalCode
  **/
  @ApiModelProperty(example = "null", value = "5 digit zip code of store location.")
   ...
   * @return country
  **/
  @ApiModelProperty(example = "null", value = "2 digit country abbreviation. 'US for United States and UK for United Kingdom.'")
  ...
  public Store products(List<Product> products) {
    this.products = products;
    return this;
  }

  public Store addProductsItem(Product productsItem) {
   ...
   * @return products
  **/
  @ApiModelProperty(example = "null", value = "Products in the given store's catalog.")
  ...
  public Store productSummary(ProductSummary productSummary) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Descriptive information on a store's products.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, store.id) &&
        Objects.equals(this.channel, store.channel) &&
        Objects.equals(this.type, store.type) &&
        Objects.equals(this.brand, store.brand) &&
        ...
        Objects.equals(this.productSummary, store.productSummary);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, channel, type, brand, postalCode, country, products, productSummary);
  }
  ...
  public String toString() {
    ...
    sb.append("    productSummary: ").append(toIndentedString(productSummary)).append("\n");
    sb.append("}");
    return sb.toString();
  }
